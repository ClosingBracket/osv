...
libc += stdio/fputc.o
musl += stdio/fputs.o
#musl += stdio/fputwc.o f->locale
#musl += stdio/fputws.o f->locale
musl += stdio/fread.o
...
#musl += stdio/fwide.o C_LOCALE, UTF8_LOCALE
musl += stdio/fwprintf.o
musl += stdio/fwrite.o
musl += stdio/fwscanf.o
libc += stdio/getc.o
musl += stdio/getc_unlocked.o
#musl += stdio/getchar.o #pthread_impl.h
...
#musl += stdio/perror.o f->locale
musl += stdio/printf.o
libc += stdio/putc.o
musl += stdio/putc_unlocked.o
#musl += stdio/putchar.o #pthread_impl.h
