...
// This test is based on tests/strings_test.cpp from the bionic project
...
// gcc tests/tst-strings.cc -lstdc++  -lboost_unit_test_framework -lboost_filesystem -o /tmp/a
